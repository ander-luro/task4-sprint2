...
- 🧪 **Query**: `db.restaurants.find({name:/^wil/i},{restaurant_id:1, name:1, borough:1, cuisine:1, _id: 0})`
- ⏱️ **Execution time**: 0 ms
- 📚 **Documents returned**: 2
- 🔍 **Documents examined**: 664
- 🛠️ **Execution stage**: PROJECTION_SIMPLE
...
- 🧪 **Query**: `db.restaurants.find({name:/ces$/i},{restaurant_id:1, name:1, borough:1, cuisine:1, _id: 0})`
- ⏱️ **Execution time**: 0 ms
- 📚 **Documents returned**: 2
- 🔍 **Documents examined**: 664
- 🛠️ **Execution stage**: PROJECTION_SIMPLE
...
- 🧪 **Query**: `db.restaurants.find({name:/Reg/i},{restaurant_id:1, name:1, borough:1, cuisine:1, _id: 0})`
- ⏱️ **Execution time**: 0 ms
