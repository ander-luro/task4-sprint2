...
- 🧪 **Query**: `db.restaurants.find({}, {_id:1, name:1})`
- ⏱️ **Execution time**: 0 ms
- 📚 **Documents returned**: 664
- 🔍 **Documents examined**: 664
...
- 🧪 **Query**: `db.restaurants.find({}, {_id:1, name:1, borough:1, cuisine:1})`
- ⏱️ **Execution time**: 0 ms
- 📚 **Documents returned**: 664
- 🔍 **Documents examined**: 664
- 🛠️ **Execution stage**: PROJECTION_SIMPLE
...
- 🧪 **Query**: `db.restaurants.find({}, {_id:1, name:1, borough:1, "address.zipcode":1})`
- ⏱️ **Execution time**: 0 ms
- 📚 **Documents returned**: 664
- 🔍 **Documents examined**: 664
...
- 🧪 **Query**: `db.restaurants.find({$and:[{cuisine:{$ne:"American"}},{"grades.score":{$gt:70}},{"location.coordinates.0":{$lt:-65.754168}}]})`
- ⏱️ **Execution time**: 0 ms
...
- 🧪 **Query**: `db.restaurants.find({name:/^wil/i},{restaurant_id:1, name:1, borough:1, cuisine:1})`
- ⏱️ **Execution time**: 1 ms
- 📚 **Documents returned**: 2
- 🔍 **Documents examined**: 664
- 🛠️ **Execution stage**: PROJECTION_SIMPLE
...
- 🧪 **Query**: `db.restaurants.find({name:/ces$/i},{restaurant_id:1, name:1, borough:1, cuisine:1})`
- ⏱️ **Execution time**: 0 ms
- 📚 **Documents returned**: 2
- 🔍 **Documents examined**: 664
- 🛠️ **Execution stage**: PROJECTION_SIMPLE
...
- 🧪 **Query**: `db.restaurants.find({name:/Reg/i},{restaurant_id:1, name:1, borough:1, cuisine:1})`
- ⏱️ **Execution time**: 0 ms
